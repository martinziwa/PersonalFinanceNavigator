...
export default function Loans() {
  ...
  const onSubmit = (data: LoanFormData) => {
    ...
    const submitData: InsertLoan = {
      ...
      isAmortized: data.interestType === "compound" ? data.isAmortized : false,
      repaymentFrequency: data.interestType === "compound" && data.isAmortized ? data.repaymentFrequency : null,
      loanTermMonths: data.isAmortized && totalMonths > 0 ? totalMonths : null,
      calculatedPayment: data.isAmortized && calculatedPayment ? calculatedPayment : null,
